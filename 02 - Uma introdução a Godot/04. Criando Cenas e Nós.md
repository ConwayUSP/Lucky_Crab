...
![no editor crie um nó label](../assets/criando-label.png)
...
![modo de movimento](../assets/modo-de-movimento.png)

Feito isso, arraste o seu *Label* para o centro da tela.

![label no centro da tela](../assets/label-no-centro-da-tela.png)
...
![salvar](../assets/save-buttons.png)
...
![Visão do FileSystem](../assets/visao-do-filesystem.png)

Eu entendo, não é a tela mais bonita ou interessante do mundo, mas o que conta é a personalidade! Você pode fechar a tela com `F8` e rodar a mesma cena novamente com `F5` (*Run Project*).
...
![formato de circulo](../assets/formato-de-circulo.png)

Muito bem, se você forçar a vista verá um pequeno circulo azul na sua tela principal, aquilo é nosso corpo rígido. Use o mouse e arreste para o centro da cena, depois disso, segure o ponto vermelho do circulo e ajuste seu raio. Algo assim:

![uma bola](../assets/a-ball.png)
...
![basket-ball|500x500](../assets/basketball-147794_1920.png)
...
![bola de basquete](../assets/node-bola-de-basquete.png)
...
![chao madeira branca](../assets/floor-624772_1280.jpg)
...
![posição da bola e da parede](../assets/ball-and-floor.png)
...
![mais uma instância de bola](../assets/more-balls.png)
